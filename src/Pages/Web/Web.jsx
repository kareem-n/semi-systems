    ...
    const FaqContent = [
        {
            ...
            desc: [`نعم، توفر لك نقرات خدمات الدعم الفني والصيانة بعد تصميم الموقع والمتجر ويشمل الدعم الفني الاستجابة لأي مشاكل فنية أو أسئلة تنشأ بعد تطبيق الموقع والمتجر بينما تتضمن الصيانة تحديثات الأمان وتصحيح الأخطاء وتحسين الأداء العام للموقع والمتجر.`]
        },
        {
            title: 'هل توفر الخدمة دعمًا فنيًا وصيانة للموقع والمتجر بعد التصميم؟',
            desc: [`نعم، توفر لك نقرات خدمات الدعم الفني والصيانة بعد تصميم الموقع والمتجر ويشمل الدعم الفني الاستجابة لأي مشاكل فنية أو أسئلة تنشأ بعد تطبيق الموقع والمتجر بينما تتضمن الصيانة تحديثات الأمان وتصحيح الأخطاء وتحسين الأداء العام للموقع والمتجر.`]
