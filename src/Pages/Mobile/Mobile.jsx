...
const Mobile = () => {
    ...
    const faqMobileContent = [
        ...
        },
        {
            ...
            answer: [
                {
                    desc: "نعم، نقدم لك في نقرات خدمة دعم فني وصيانة للتطبيقات الجوالة. وهذه الخدمة مهمة لضمان أن التطبيق يعمل بشكل سلس ولا يواجه أي مشاكل فنية في المستقبل."
                },
            ]
        },
        {
        ...
        },
        {
            ...
            answer: [
                {
                    desc: "نعم، بالطبع نوفر لك في نقرات إمكانيه تطوير تطبيق جوال متوافق مع جميع أنظمة التشغيل مثل نظام تشغيل iOS لأجهزة آبل ونظام تشغيل Android لأجهزة سامسونج وأجهزة أخرى."
                },
            ]
        },
        {
            ...
            answer: [
                {title: "تصميم تطبيق جوال ناجح في نقرات يتطلب خطوات أساسية ومهمة ومنها ما يلي: "},
