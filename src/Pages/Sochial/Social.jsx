...
const Social = () => {
    ...
    const faqSocialContent =[
        ...
        },
        {
            ...
            answer: [
                {title: "نعم، في نقرات نقدم لك خدمة إدارة حسابات التواصل الاجتماعي على منصات متعددة مثل :"},
                {details: "1-", dasc: "فيسبوك"},
                {details: "2-", dasc: "إنستغرام"},
                {details: "3-", dasc: "تويتر"},
                {details: "4-", dasc: "لينكد إن وغيرها."},
            ]
        },
        ...
        },
        {
            ...
            answer: [
                {title: "خدمة إدارة حسابات التواصل الاجتماعي هي خدمة توفرها لك نقرات للمساعدة في إدارة وتحسين أداء حسابات وسائل التواصل الاجتماعي للأفراد والشركات وتشمل :"},
